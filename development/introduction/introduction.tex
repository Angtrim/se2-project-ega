...
%%%%%%%%%%%%%%
\paragraph{Mobile Application (User)} % (fold)
\label{app:mobileuser}
  ...
  It gives the \emph{user} the opportunity to manage his profile, request a taxi and make or dismiss a reservation. %TODO: and maybe more
...
\paragraph{Mobile Application (Taxi Driver)} % (fold)
