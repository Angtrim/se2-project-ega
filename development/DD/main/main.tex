...
{\large \today \\Version 1.1} % Date, change the \today to a set date if you want to be precise
...
\import{../data-management/}{data.tex}
\newpage
% 9 - Algorithm desing
...
\import{../requirements-traceability/}{requirements-traceability.tex}
% 12 - Appendix
