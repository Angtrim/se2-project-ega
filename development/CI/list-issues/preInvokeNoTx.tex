...
\subsection{preInvokeNoTx} % (fold)
\label{sub:preinvokenotx}

\paragraph{Method}
\label{par:method}
\begin{itemize}
	\item \textbf{Name:} preInvokeNoTx( EjbInvocation inv )
	\item \textbf{Start Line:} 1599
...
\begin{enumerate}
	...
	\item \emph{\checkB}: \textbf{In \emph{line 1609} a single char name is used for a not throwaway var.}
