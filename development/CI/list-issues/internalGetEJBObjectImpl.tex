...
\begin{enumerate}
	\item \emph{\checkA}: \textbf{Method name it's not auto-explicative and doesn't follow the standard naming convention. ``getInternalEJBObjectImplementation'' would be better}.
