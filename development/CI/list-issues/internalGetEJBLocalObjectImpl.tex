...
\begin{enumerate}
	\item \emph{\checkA}: Method name it's not auto-explicative and doesn't follow the standard naming convention. "getInternalEJBLocalObjectImplementation" would be better.
...
\begin{enumerate} [resume]
	\item \emph{\checkR}: Not totally explicative and quite confusing.
...
\begin{enumerate} [resume]
	...
	\item \emph{\checkW}: Javadoc doesn't exist on this method.
\end{enumerate}
