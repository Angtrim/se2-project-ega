...
\begin{itemize}
	...
	\item $E$ is an aggregation of five scale factors (SF) (retrieved in the \emph{\nameref{sub:scale_factors}} section)
	\item $EM$ are the \emph{effort multipliers} of the \emph{cost drivers} (retrieved in the \emph{\nameref{sub:cost_drivers}} section)
\end{itemize}
