%!TEX root = ../main.tex
\section{Project size, effort and cost}
\subsection{Function Points Approach} % (fold)
...
\subsubsection{Function Points Tables} % (fold)
...
% subsubsection function_points_tables (end)

\subsubsection{External Input} % (fold)
...
\subsubsection{External Outputs} % (fold)
...
\subsubsection{External Inquiry} % (fold)
\label{sub:external_inquiry}
\begin{itemize}
	\item Ride sharing request
\end{itemize}

\subsubsection{Internal Logical Files} % (fold)
...
\subsubsection{External Logical Files} % (fold)
\label{sub:internal_logical_files}
\begin{itemize}
	\item Google Maps (from Google Maps API)
\end{itemize}

\subsubsection{Unadjusted Function Points} % (fold)
