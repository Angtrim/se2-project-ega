...
\paragraph{\nameref{app:mobileuser}} 
The developer of the \textbf{\nameref{app:mobileuser}} must follow the design guideline [rif needed ] of the platform and has to interface with the respective Developer Console and make sure that the app will be accepted and published. \\
